<?php
    ...
    $styles = '
        ...
        <link rel="stylesheet" href="' . HTTP_URL . 'js/lib/scrollbar/scrollbar.css" type="text/css" media="screen, projection" />
    ';
    ...
    <script type="text/javascript" src="' . HTTP_URL . 'js/lib/scrollbar/scrollbar.js?v=0.6.0"></script>
